    ...
    payload = {
        "blocks": [
            ...
            },
            {
                ...
                "accessory": {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "PRIMARY LINK", "emoji": True},
                    "value": "click_me_123",
            ...
            },
            {
                ...
                "accessory": {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "INVOICE LINK", "emoji": True},
                    "value": "click_me_123",
            ...
            },
            {
                ...
                "accessory": {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "SOLD INVENTORY LINK", "emoji": True},
                    "value": "click_me_123",
            ...
            },
            {
                ...
                "accessory": {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "INVENTORY LINK", "emoji": True},
                    "value": "click_me_123",
            ...
            },
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "emoji": True, "text": "Purchased"},
                        "style": "primary",
                        "value": "Purchased - %s" % (invoiceid),
                    },
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "emoji": True, "text": "Reassign"},
                        "style": "danger",
